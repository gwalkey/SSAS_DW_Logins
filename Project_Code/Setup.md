...
When the server lays down the XEL file every day, your file-copy PoSH script (here)<br>
...
will also need to be updated to use the same path but using a UNC syntax instead such as:<br>
\\server1\d$\traces\ <br>
